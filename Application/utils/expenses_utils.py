...
def add_expense(form_data, user_id):
    ...
    db.execute(
        "INSERT INTO expenses (description, category_id, expense_date, amount, payer_id, submit_time, user_id, budget_id) VALUES (:description, :category_id, :expense_date, :amount, :payer_id, :submit_time, :user_id, :budget_id)",
        {
